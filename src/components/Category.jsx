...
e.dataTransfer.setData("dataShared", JSON.stringify(dataShare))
  ...
  return (
    <>
        <div className='w-100 mt-1 md-1 mt-5 p-4'>
            <button onClick={handleShow} className='btn btn-warning w-100 rounded-3' >Add New Category <FontAwesomeIcon icon={faPlus} /> </button>
